...
export const getSV = (context: CanvasRenderingContext2D) => {
    ...
    const paint = (paintObject: SVPaint) => {
        paintMethods[paintObject.type](paintObject.type);
    };

    return {paint};
};

// const createPaintMethods: () => Record<TaskType, () => > = (context: CanvasRenderingContext2D) => ({
